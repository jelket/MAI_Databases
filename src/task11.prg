SELECT;
	dtp1.description description1, v1.law law1, dtp1.dtp_date date1, ;
	dtp2.description description2, v2.law law2, dtp2.dtp_date date2, ;
	person.name;
FROM;
